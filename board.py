...
class Board(): # ボードを定義するクラス
    ...
    def clear(self):
        ...
        self.flag_list=[[False for i in range(self.board_size[1])]for j in range(self.board_size[0])] #self.display_list=[[True for i in range(self.board_size[1])]for j in range(self.board_size[0])]
